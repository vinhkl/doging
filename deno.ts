...
const UUID: string = Deno.env.get("UUID") || "854937f4-c6f3-4fde-97f0-7091aceb54eb";
const SUB_PATH: string = Deno.env.get("SUB_PATH") || "sub";  //获取订阅路径
const XPATH: string = Deno.env.get("XPATH") || "xhttp";      // 节点路径
const DOMAIN: string = Deno.env.get("DOMAIN") || "vinhkl-doging-86.deno.dev";         // deno分配的域名必填，不带https://前缀，例如：xxxx.deno.dev      
